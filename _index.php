...
////////////////////////////////////////////////////////////////////////////////
// ALTAFORM 3.0 MODULE LOADER
////////////////////////////////////////////////////////////////////////////////
require_once(is_owner(__DIR__.'/modules/module.php'));
...
// SET DEFAULT ALTAFORM SETTINGS
////////////////////////////////////////////////////////////////////////////////
if (!empty($af->settings['router'])) {
	$router->import($af->settings['router']);
}
...
////////////////////////////////////////////////////////////////////////////////
// SET DEFAULT OPEN GRAPH SETTINGS
////////////////////////////////////////////////////////////////////////////////
if (!empty($af->settings['opengraph'])) {
	$og = @json_decode($af->settings['opengraph'], true);
	if (!is_array($og)) $og = [];
}
